// Editorial-style analytics module — matches Work / Resume card language
const DashboardLive = () => {
  const [now, setNow] = React.useState(new Date());
  const [range, setRange] = React.useState('24W');
  React.useEffect(() => {
  ...
  return (
    <section id="dashboard" style={{ padding: '48px 0 24px' }}>
      <div className="container">
        <SectionTabs active="Dashboard" />

        {/* Header row — mirrors Hero composition: text-left, blue square right */}
        ...
        {/* KPI tiles — 3 separate cards, matches editorial language */}
