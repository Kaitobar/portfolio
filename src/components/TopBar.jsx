export const TopBar = ({ section = 'Portfolio' }) => (
  <div style={{
    display: 'flex',
    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
      ...
      <span className="grotesk" style={{ fontSize: 18, fontWeight: 600 }}>Katherin L. T.</span>
    </div>
    <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
      <span className="grotesk" style={{ fontSize: 16, fontWeight: 500 }}>{section}</span>
      <span style={{
        width: 32, height: 32, borderRadius: '50%',
...
export const SectionTabs = ({ active = 'About me', tabs = ['About me', 'Resume', 'Work'] }) => (
  <div style={{
    display: 'flex',
    justifyContent: 'space-between',
    alignItems: 'center',
