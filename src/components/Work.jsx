...
const cases = [
  ...
  },
  {
    ...
    detail: 'Managed and optimized WordPress sites for multiple clients. Day to day work included publishing and updating content, configuring key plugins like Yoast SEO, Wordfence, and WPML, and handling technical settings such as permalink structure and canonical URLs to ensure proper indexing.\n\nOn the SEO side, I optimized meta titles, meta descriptions, and target keywords for each page using Yoast SEO, making sure every page was properly configured for search engines. I also managed page categories, schema markup, and readability settings to improve both rankings and user experience.\n\nTools used: WordPress, Yoast SEO, Wordfence, WPML',
    images: ['https://i.ibb.co/849Kkpzv/Captura-de-pantalla-2026-05-06-235444.png', 'https://i.ibb.co/tT1JhwDn/Captura-de-pantalla-2026-05-07-004132.png'],
    accent: 'var(--ink)',
    fg: 'var(--paper)',
    icon: '⚡',
  },
